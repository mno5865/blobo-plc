...
public class MemoryAllocation {
    ...
    private static ArrayList<String> handleConcatRecursive(ExprNode expr) throws SemanticException {
        ...
        outputLines.add("");
        if (expr instanceof FuncCallNode funcCallExpr && functionContainsConcat((FuncCallNode) expr)) {
        ...
        if (expr instanceof FuncCallNode funcCallExpr && ((FuncCallNode)expr).getName().equals("concat")) {
        ...
        if (expr instanceof BinaryOperationNode exprOperation) {
